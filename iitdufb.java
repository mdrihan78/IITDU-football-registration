...
public class iitdufb {
  public static void main(String[] args) {
    ...
    String[] degrees = { "Select", "BSSE", "MSSE", "MIT" };
    JComboBox<String> degreeBox = new JComboBox<>(degrees);
    degreeBox.setBounds(150, 260, 100, 25);
    ...
    positionLabel.setBounds(30, 340, 200, 25);
    String[] positions = { "Select", "Goal keeper", "Defender", "Midfielder", "Forward" };
    JComboBox<String> positionBox = new JComboBox<>(positions);
    positionBox.setBounds(150, 340, 100, 25);

    frame.add(positionLabel);
    frame.add(positionBox);

    JLabel interDepLabel = new JLabel("Did you played in the inter departmental competition ?");
    interDepLabel.setBounds(30, 380, 400, 25);
    frame.add(interDepLabel);

    JRadioButton yesButton = new JRadioButton("Yes");
    yesButton.setBounds(350, 380, 60, 25);
    JRadioButton noButton = new JRadioButton("No");
    noButton.setBounds(420, 380, 60, 25);

    ButtonGroup intdepGroup = new ButtonGroup();
    intdepGroup.add(yesButton);
    intdepGroup.add(noButton);
    frame.add(yesButton);
    frame.add(noButton);

    JLabel expLabel = new JLabel("Experience :");
    expLabel.setBounds(30, 420, 100, 25);
    JTextField expField = new JTextField();
    expField.setBounds(150, 420, 300, 100);
    frame.add(expLabel);
    frame.add(expField);

    JButton registrationButton = new JButton("Register");
    registrationButton.setBounds(300, 550, 100, 25);
    ...
    registrationButton.addActionListener(e -> {
      ...
      String gender = male.isSelected() ? "Male"
          : female.isSelected() ? "Female" : other.isSelected() ? "Others" : "Not selected";
      ...
      String interdep = yesButton.isSelected() ? "Yes" : noButton.isSelected() ? "No" : "Not selected";
      String experience = expField.getText();

      if (name.isEmpty() || phone.isEmpty() || email.isEmpty() || address.isEmpty() || gender.equals("Not selected")
          || degree.equals("Select") || position.equals("Select") || interdep.equals("Not selected")
          || experience.isEmpty()) {
        ...
        try {
          ...
          writer.write("Played in inter departmental competition :" + interdep + "\n");
